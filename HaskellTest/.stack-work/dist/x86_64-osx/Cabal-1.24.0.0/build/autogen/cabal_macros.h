...
/* package HaskellTest-0.1.0.0 */
#define VERSION_HaskellTest "0.1.0.0"
#define MIN_VERSION_HaskellTest(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "HaskellTest-0.1.0.0-6OgzhtgCfMpDngCSuhhc2u"

#define CURRENT_PACKAGE_KEY "HaskellTest-0.1.0.0-6OgzhtgCfMpDngCSuhhc2u"
