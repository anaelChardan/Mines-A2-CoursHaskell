...
testSplitMap :: Bool
testSplitMap =
  splitMap [(France, [Blue]), (Belgium, [Blue, Red, Yellow]), (Italy, [Red, Green])] ==
  ( [(France, [Blue]), (Belgium, [Blue]), (Italy, [Red, Green])]
...
testGenerate :: Bool
testGenerate =
  generateMap [(France, [Blue, Yellow]), (Italy, [Red, Green])] ==
  [ [(France, [Blue]), (Italy, [Red])]
  , [(France, [Blue]), (Italy, [Green])]
  , [(France, [Yellow]), (Italy, [Red])]
  , [(France, [Yellow]), (Italy, [Green])]
  ]
...
testWriteCountry =
  writeCountry France [Blue, Red] [(Belgium, [Red]), (France, [Blue, Red, Yellow]), (Italy, ([Red]))] ==
...
testSearch =
  searchMap
    [(Belgium, France), (Belgium, WestGermany), (France, WestGermany)]
    [(France, [Blue]), (Belgium, c4), (WestGermany, c4)] ==
  [ [(France, [Blue]), (Belgium, [Red]), (WestGermany, [Yellow])]
  , [(France, [Blue]), (Belgium, [Red]), (WestGermany, [Green])]
  , [(France, [Blue]), (Belgium, [Yellow]), (WestGermany, [Red])]
  , [(France, [Blue]), (Belgium, [Yellow]), (WestGermany, [Green])]
  , [(France, [Blue]), (Belgium, [Green]), (WestGermany, [Red])]
  , [(France, [Blue]), (Belgium, [Green]), (WestGermany, [Yellow])]
  ]
